...
void k_term_init() {
    ...
    // ------------------------------------------------------------
    k_term_func[ k_term_cmd_ttl ]  = (uint32_t*)  &read_sec;
    k_term_cmds[ k_term_cmd_ttl++ ] = "read_sec";

    k_term_func[ k_term_cmd_ttl ]  = (uint32_t*)  &write_sec;
    k_term_cmds[ k_term_cmd_ttl++ ] = "write_sec";
...
uint8_t k_term_parse_cmd_line( char * cmd ) {
    ...
    // ------------------------------------------------------------
    // FIXME;
    // TODO; Replace all external calls to local. Implemention ???
    // FIXME;
