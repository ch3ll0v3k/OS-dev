...
void PROCESS_3() {
    ...
    sprintf( PROCESS_CHAR_BUFF, "TSK 3: %d       ", PROCESSES_DATA[ CURRENT_PROCESS_ID ] );
...
void PROCESS_2() {
    ...
    sprintf( PROCESS_CHAR_BUFF, "TSK 2: %d       ", PROCESSES_DATA[ CURRENT_PROCESS_ID ] );
...
void PROCESS_1() {
    ...
    sprintf( PROCESS_CHAR_BUFF, "TSK 1: %d       ", PROCESSES_DATA[ CURRENT_PROCESS_ID ] );
...
void PROCESS_0() {
    ...
    sprintf( PROCESS_CHAR_BUFF, "TSK 0: %d       ", PROCESSES_DATA[ CURRENT_PROCESS_ID ] );
