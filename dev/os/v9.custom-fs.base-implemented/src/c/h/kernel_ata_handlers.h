...
#define ATA_CMD_SETMULT         0xC6    // Set Multiple Mode  [CHANGE THE SECTORS PER BLOCK]
...
#define ATA_CMD_FLUSH           0xE7    // Flush
...
#define ATAP_READY_SPP          0x58    // 01011000b which means the busy bit is clear, the RDY bit is set, and the DRQ bit is set.
