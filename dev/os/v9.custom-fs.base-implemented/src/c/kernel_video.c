...
void set_vid_mod(uint32_t width, uint32_t height, uint32_t bpp, uint8_t use_lineare ) {
    ...
    if ( use_lineare ) {
        printf("use_lineare: [1]\n");
    }
}

uint16_t bga_reg(uint16_t index_val) {
    outw(VBE_DISPI_IOPORT_INDEX, index_val);
...
void bga_set_bank(uint16_t bank_number) {
    _vid_reg(VBE_DISPI_INDEX_BANK, bank_number);
}
...
void foo() {
    ...
    set_vid_mod(screenWidth, screenHeight, ppb, 1);
    ...
    while ( Y < 640 * 480 ) {
        ...
        //*( (uint32_t *) ( 0xA0000 + 100 + Y + 1020)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 101 + Y + 1021)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 102 + Y + 1022)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 103 + Y + 1023)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 104 + Y + 1024)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 105 + Y + 1025)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 106 + Y + 1026)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 107 + Y + 1027)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 108 + Y + 1028)) = 0b11111000;
        //*( (uint32_t *) ( 0xA0000 + 109 + Y + 1029)) = 0b11111000;
    }
